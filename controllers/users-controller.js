...
const loginUser = async (userData) => {
  try {
    ...
    // secretKey - your app's exclusive key used to sign the token when it's created and verify the token when the user tries to access a protected route (your app's signature) (can generate these online!)
